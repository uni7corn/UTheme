...
import com.uni7corn.utheme.App;
...
public class ViewAttributeUtil {
    ...
    public static String getResourceName(AttributeSet attr, int paramInt) {
        int count = attr.getAttributeCount();
        for (int index = 0; index < count; index++) {
            if (attr.getAttributeNameResource(index) == paramInt) {
                int nameResource = attr.getAttributeResourceValue(index, 0);
                return App.getAppContext().getResources().getResourceName(nameResource).split("/")[1];
            }
        }
        return null;
    }
    ...
    public static void applyImageDrawable(ITheme ci, Resources.Theme theme, int paramInt) {
        TypedArray ta = theme.obtainStyledAttributes(new int[]{paramInt});
        Drawable drawable = ta.getDrawable(0);
    ...
    public static void applyTextAppearance(ITheme ci, Resources.Theme theme, int paramInt) {
        TypedArray ta = theme.obtainStyledAttributes(new int[]{paramInt});
    ...
    public static void applyTextColor(ITheme ci, Resources.Theme theme, int paramInt) {
        TypedArray ta = theme.obtainStyledAttributes(new int[]{paramInt});
